...
export default function SpendingScreen() {
  ...
  return (
    <div className="stack">
      ...
      {summary.total === 0
        ? <Empty title="Поки немає жодного поповнення з ціною" />
        : <>
            <details className="info">
              <summary>Звідки ці числа</summary>
              <p>
                Рахуються поповнення, у яких вказана ціна: кількість помножена
                на ціну за одиницю. Поповнення без ціни сюди не потрапляють,
                тож справжні витрати можуть бути більшими.
              </p>
            </details>
